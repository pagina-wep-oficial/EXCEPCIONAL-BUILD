...
db.from("client_requests").select("*").eq("project_id",id).order("created_at",{ascending:false}),
    ...
    if(editorCard && !archivedState){
      ...
      editorCard.innerHTML=active?`
        ...
        <div class="editor-rules"><p>El acceso dura el periodo pagado. Si vence, tu pagina sigue en linea, pero el editor se pausa.</p><a href="politicas-editor.html" target="_blank" rel="noopener">Ver reglas de cancelacion y reembolso</a></div>
